...
class Map extends React.Component {
   ...
   render () {
        return (
<div className='Map'>
<div style={{display: this.props.state.open2 === true ? 'block' : 'none'}} className='notif2'> <p>Nous y voila ! Découvre quelques anecdotes concernant NADAR. C’est parti !</p><br/><Link to='/Erreur2'><button onClick={()=> this.props.MouseOff2()}className='enter2'>ENTER</button></Link></div>
